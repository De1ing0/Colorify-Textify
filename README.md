When Colorify/Textify is used for the first time, user needs to login into their Spotify account.
...
Dont forget to set up .env file beforehand with client_id and client_secret from Spotify Developer Portal